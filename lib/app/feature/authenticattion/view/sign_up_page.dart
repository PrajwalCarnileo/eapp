...
import 'package:education_app/app/feature/authenticattion/viewmodel/sign_up_page_viewmodel.dart';
...
class SignUpPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final viewmodel = ref.watch(SignUpPageViewmodel.provider);
    return Scaffold(
      body: SafeArea(
